<template>
  <div class="min-h-screen bg-gray-50 dark:bg-gray-900 py-4 px-4 pb-72">
    <div class="max-w-2xl mx-auto">
      ...
      <!-- 數字鍵盤（固定在底部）-->
      <div class="fixed bottom-0 left-0 right-0 bg-gray-50/95 dark:bg-gray-900/95 backdrop-blur-sm border-t border-gray-200 dark:border-gray-700 px-4 pt-2 pb-4 z-20">
        <NumberKeypad
